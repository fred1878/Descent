...
class ConfusedEnemy(BaseAI):
    ...
    def perform(
            self) -> None:  # Its possible the actor will just bump into the wall, wasting a turn. The actor will either try to move or attack in the chosen random direction.
