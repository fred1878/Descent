...
def generate_dungeon(
    ...
    entity_factories.ally.spawn(dungeon, player.x + 2, player.y)
    entity_factories.ally.spawn(dungeon, player.x + 2, player.y + 1)
    entity_factories.resurrect_scroll.spawn(dungeon, player.x + 1, player.y)
